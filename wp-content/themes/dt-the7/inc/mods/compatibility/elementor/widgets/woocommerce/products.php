...
class Products extends The7_Elementor_Widget_Base {
	...
	protected function get_query() {
		...
		$query_manager = new Products_Query( $settings, 'query_' );

		$query_args = $query_manager->parse_query_args();

		$query_manager->add_pre_query_hooks();

		$products_query = new WP_Query( $query_args );

		$query_manager->remove_pre_query_hooks();
