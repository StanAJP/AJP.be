...
class Simple_Product_Categories extends Simple_Widget_Base {
	...
	public function get_style_depends() {
		return [ 'the7-simple-product-categories', 'the7-simple-common' ];
	}
	...
	// TODO: remove
	protected function old_add_image_style_controls() {
		// Featured Image.
		$this->start_controls_section(
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} [class*="the7-simple-widget"]'                                                                      => '--image-size: {{SIZE}}{{UNIT}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .post-thumbnail-rollover',
				'exclude'	=> [
					'color'
				]
			]
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .post-thumbnail-rollover, {{WRAPPER}} .the7-simple-post-thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .post-thumbnail-rollover' => 'border-color: {{VALUE}}',
                ]
            ]
        );
		...
		$this->add_group_control(
			...
			[
				'name'      => 'img_shadow',
				'selector'  => '
				{{WRAPPER}} .post-thumbnail-rollover
				',
			]
		);
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'
							{{SELECTOR}},
							{{WRAPPER}} .post-thumbnail-rollover:before, {{WRAPPER}} .post-thumbnail-rollover:after { transition: opacity 0.3s ease; } {{SELECTOR}}' => 'background: {{VALUE}} !important;',
						],
					],
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} a.wf-cell:hover .post-thumbnail-rollover,
					{{WRAPPER}} .post-thumbnail-rollover:hover' => 'border-color: {{VALUE}}',
                ]
            ]
        );
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '
				{{WRAPPER}} a.wf-cell:hover .post-thumbnail-rollover,
					{{WRAPPER}} .post-thumbnail-rollover:hover',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '
				{{WRAPPER}} a.wf-cell:hover .post-thumbnail-rollover img,
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'
					{{WRAPPER}} .post-thumbnail-rollover img { transition: opacity 0.3s ease; }
					{{WRAPPER}} a.wf-cell:hover .post-thumbnail-rollover img,
