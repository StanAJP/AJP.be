...
class Horizontal_Menu extends The7_Elementor_Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .horizontal-menu-dropdown' => 'top: calc(100% + {{TOP}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav, {{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav .horizontal-sub-nav' => 'min-width: calc({{SIZE}}{{UNIT}} - var(--sub-menu-right-gap, 0px) - var(--sub-menu-left-gap, 0px)); --sub-menu-width: {{SIZE}}{{UNIT}};',
					' {{WRAPPER}} .horizontal-menu-dropdown' => 'min-width: calc({{SIZE}}{{UNIT}} - var(--sub-menu-right-gap, 0px) - var(--sub-menu-left-gap, 0px)); --sub-menu-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav, {{WRAPPER}} .horizontal-menu-dropdown' => '--submenu-padding-top: {{TOP}}{{UNIT}}; --submenu-padding-right: {{RIGHT}}{{UNIT}}; --submenu-padding-bottom: {{BOTTOM}}{{UNIT}}; --submenu-padding-left: {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .horizontal-menu-dropdown' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav:before, {{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav .horizontal-sub-nav, {{WRAPPER}} .horizontal-menu-dropdown' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav:before, {{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav .horizontal-sub-nav, {{WRAPPER}} .horizontal-menu-dropdown' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav:before, {{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav .horizontal-sub-nav, {{WRAPPER}} .horizontal-menu-dropdown' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav:before, {{WRAPPER}} .dt-nav-menu-horizontal > li > .horizontal-sub-nav .horizontal-sub-nav, {{WRAPPER}} .horizontal-menu-dropdown',
			]
		);
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .horizontal-sub-nav > li a' => '{{VALUE}};',
	...
	protected function get_less_file_name() {
		return PRESSCORE_THEME_DIR . '/css/dynamic-less/elementor/the7-horizontal-menu.less';
	}
	...
	protected function less_vars( The7_Elementor_Less_Vars_Decorator_Interface $less_vars ) {
		...
		$less_vars->add_keyword( 'widget-unique-selector', 'elementor-element-' . $this->get_id(), '~"%s"' );
	}
