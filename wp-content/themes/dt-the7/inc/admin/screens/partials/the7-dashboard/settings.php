			...
			<div class="the7-column">
				<table class="the7-system-status">
                    ...
                    <?php if ( the7_elementor_is_active() ): ?>
                        <tr>
                            <td>
                                <label for="the7-elementor-buttons-integration"><?php esc_html_e( 'Elementor buttons integration', 'the7mk2' ); ?></label>
                            </td>
                            <td>
                                <input type="checkbox" id="the7-elementor-buttons-integration" name="the7_dashboard_settings[elementor-buttons-integration]"<?php checked( The7_Admin_Dashboard_Settings::get( 'elementor-buttons-integration' ) ); ?>>
                            </td>
                        </tr>
						<tr>
							<td>
								<label for="the7-elementor-theme-style"><?php esc_html_e( 'Enable Elementor Theme Style (and disable Theme Options)', 'the7mk2' ); ?></label>
							</td>
							<td>
								<input type="checkbox" id="the7-elementor-theme-style" name="the7_dashboard_settings[elementor-theme-style]"<?php checked( $elementor_theme_style ); ?>>
							</td>
						</tr>
	                    <?php if ( !$elementor_theme_style ): ?>
                            ...
                            <tr <?php echo(  $hide_tr ); ?>>
                                <td>
                                    <label for="the7-elementor-theme-style-migrate"><?php _e( 'Would you like to generate Global Colors<br>and Fonts based on Theme Options?', 'the7mk2' ); ?></label>
                                </td>
                                <td>
                                    <select id="the7-elementor-theme-style-migrate" name="the7_dashboard_settings[elementor-theme-style-migrate]">
